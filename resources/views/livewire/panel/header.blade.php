            ...
            >
                <div>
                    ...
                    <ul class="w-full flex flex-col gap-2.5 *:p-2.5 pt-2.5">
                        <li class="*:w-full *:h-full *:cursor-pointer bg-green-500/20 rounded-lg"><a href="#" class="flex gap-x-2"><svg class="w-6 h-6 fill-transparent">
                                    <use xlink:href="#icon-check-circle"></use>
                                </svg><span>لیست فیلم ها</span></a></li>
                        <li class="*:w-full *:h-full *:cursor-pointer bg-red-500/20 rounded-lg"><a href="#" class="flex gap-x-2"><svg class="w-6 h-6 fill-transparent">
                                    <use xlink:href="#icon-close-circle"></use>
                                </svg><span>لیست فیلم ها</span></a></li>
                        <li class="*:w-full *:h-full *:cursor-pointer bg-yellow-500/20 rounded-lg"><a href="#" class="flex gap-x-2"><svg class="w-6 h-6 fill-transparent">
                                    <use xlink:href="#icon-danger-circle"></use>
                                </svg><span>لیست فیلم ها</span></a></li>
                        <li class="*:w-full *:h-full *:cursor-pointer bg-blue-500/20 rounded-lg"><a href="#" class="flex gap-x-2"><svg class="w-6 h-6 fill-transparent">
