        ...
        <div class="card-body">
            ...
            <div class="flex flex-col-reverse md:flex-row md:justify-between items-start">
                ...
                <div class="flex gap-x-1 w-full md:w-max justify-between">
                    <a href="{{ route('panelAdmin.countries.create') }}" class="bg-green-500 text-white w-max px-3.5 py-2 rounded-lg">افزودن</a>
                </div>
            </div>
                ...
                <div class="parent-table w-max md:w-full overflow-auto md:overflow-hidden" wire:key="user-list-table">
                    <table class="box-table">
                        ...
                        @foreach($countries as $country)
                            <tr class="table-item">
                                <td><span class="font-medium">{{ $country->name_en }}</span></td>
                                <td><span class="font-medium">{{ $country->name_fa }}</span></td>
                                <td><span class="font-medium">{{ $country->code }}</span></td>
                                <td class="flex justify-center items-end gap-x-2.5">
                                    ...
                                    <div x-data="{ showDeleteModal: @entangle('showDeleteModal') }">
                                        ...
                                        <a href=""
                                           ...
                                           wire:click.prevent="openDeleteModal({{ $country->id }})">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <p>آیا مطمئن هستید که می‌خواهید این کشور را حذف کنید؟</p>
